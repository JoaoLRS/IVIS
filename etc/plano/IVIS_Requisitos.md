...
- **RF02**: O sistema deve permitir que Aluno e Instituição de Ensino gerenciem os dados da própria conta (dados pessoais/institucionais, senha).
...
- **RF10**  O sistema deve permitir que o Aluno consulte seu histórico de treinos, exibindo data, vaga/habilidade treinada e resultado.
...
- **RF12**: A Home com os planos disponíveis deve poder ser visualizada por um visitante não autenticado, antes da criação de conta. 
...
- **RF16**: O sistema deve permitir que a Instituição de Ensino gerencie (visualize, cadastre/vincule e remova) alunos dentro do limite de vagas do plano de consórcio contratado.
